...
p2m1_func <- function(N, k, k_size, ex) {
  ...
  sim_class  <- mplusObject(
    TITLE = glue("P2M1 - N{N} - C{k} - {k_size} - Realistic Separation;"),
    ...
    MONTECARLO = glue(
      "NAMES = u1-u10 x1 x2 x3;
   	...
   	NREPS = 500;
    {ex}REPSAVE = all;
    {ex}SAVE= p2m1_N{N}_C{k}_{k_size}_realistic*.csv;
    RESULTS = p2m1_N{N}_C{k}_{k_size}_realistic_results.csv;"
    ),
...
{ex}%C#1%
  ...
  {ex}[u1$1*3.19064 u2$1*3.10788 u3$1*3.83448 u4$1*3.86343 u5$1*2.00700
  {ex}u6$1*2.92895 u7$1*1.43653 u8$1*2.75844 u9$1*3.01256 u10$1*1.89987];

{ex}%C#2%

  {ex}[u1$1*1.16631 u2$1*-0.15619 u3$1*3.77549 u4$1*-0.51226 u5$1*-1.58301
  {ex}u6$1*0.11202 u7$1*-2.15707 u8$1*0.57930 u9$1*-0.28985 u10$1*-0.19538];

{ex}%C#3%

  {ex}[u1$1*-0.56244 u2$1*-0.06104 u3$1*-0.74264 u4$1*0.58389 u5$1*-1.44290
  {ex}u6$1*-15.0 u7$1*0.17762 u8$1*2.74127 u9$1*1.67876 u10$1*2.60714];

{ex}%C#4%

  {ex}[u1$1*-2.13783 u2$1*-3.46779 u3$1*-3.17454 u4$1*-2.12725 u5$1*-2.57868
  {ex}u6$1*-3.62206 u7$1*-3.27125 u8$1*-0.67695 u9$1*-1.86035 u10$1*-1.42219];

{ex}%C#5%

  {ex}[u1$1*-0.69130 u2$1*-1.27803 u3$1*-0.05214 u4$1*1.48891 u5$1*1.99572
  {ex}u6$1*1.75719 u7$1*-0.18973 u8$1*1.46395 u9$1*0.41521 u10$1*0.38082];
"),
  ...
  base_dir <- here("dissertation", "complex", "p2", "m1", "realistic")
