...
{ex}%C#1%
  ...
  {ex}[u1$1*-2.1 u2$1*-2.120 u3$1*-2.737 u4$1*-4.172 u5$1*-1.591
  {ex}u6$1*-3.187];

{ex}%C#2%

  {ex}[u1$1*-0.2 u2$1*-0.329 u3$1*-0.127 u4$1*-1.199 u5$1*1.591
  {ex}u6$1*1.710];

{ex}%C#3%

  {ex}[u1$1*-1.5 u2$1*-0.738 u3$1*0.888 u4$1*0.964 u5$1*0.039
  {ex}u6$1*-15.000];

{ex}%C#4%

  {ex}[u1$1*1 u2$1*1.547 u3$1*3.910 u4$1*2.382 u5$1*3.483
  {ex}u6$1*15.000];
"),
  ...
  base_dir <- here("dissertation", "simple", "p2", "m1", "realistic")
