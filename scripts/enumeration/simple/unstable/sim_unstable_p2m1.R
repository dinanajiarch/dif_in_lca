...
p2m1_func <- function(N, k, k_size, ex) {
  ...
  sim_class  <- mplusObject(
    ...
    {ex}[u1$1*-0.5 u2$1*-0.3 u3$1*-0.2 
    {ex}u4$1*0.1 u5$1*0.3 u6$1*0.2];

    {ex}%C#2%

    {ex}[u1$1*0.1 u2$1*-0.1 u3$1*0.2
    {ex}u4$1*-0.2 u5$1*-0.1 u6$1*0.0];

    {ex}%C#3%

    {ex}[u1$1*0.0 u2$1*0.1 u3$1*-0.1
    {ex}u4$1*0.2 u5$1*-0.3 u6$1*-0.2];

    {ex}%C#4%

    {ex}[u1$1*0.5 u2$1*0.6 u3$1*0.4 
    {ex}u4$1*0.7 u5$1*0.5 u6$1*0.6];"
           ),
  ...
  base_dir <- here("dissertation", "simple", "p2", "m1", "unstable")
...
# This is so we create the datasets for k=4 only
p2$ex <- ifelse(p2$k == 4, "", "!")
